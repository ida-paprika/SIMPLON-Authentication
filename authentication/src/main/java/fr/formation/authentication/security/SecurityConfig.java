...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	http.csrf().disable().httpBasic().disable()
		...
		// Apply business requirements security
		.and().authorizeRequests()
		.antMatchers(HttpMethod.POST, "/accounts", "/accounts/login")
		.permitAll()
		// .anonymous() forbids access to logged users
		...
		.hasRole("MANAGER")
		.antMatchers(HttpMethod.GET, "/tests/admin-basic")
		.hasAnyRole("BASIC", "ADMIN")
		.antMatchers(HttpMethod.GET, "/tests/admin-manager")
